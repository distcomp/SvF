...
#            cs = plt.contourf(X, Y, z, levs, cmap=cm.gray) #gray
            ...
            if Transp :
                plt.plot ( tbG[:,1],tbG[:,0],'b+', label="green+", markersize=ms*MULT, marker='o',  linestyle='-', linewidth=lw*MULT )
            else      :
                plt.plot ( tbG[:,0],tbG[:,1],'b+', label="green+", markersize=ms*MULT, marker='o',  linestyle='-', linewidth=lw*MULT )
...
#    colors = [ "g+", "b+", "r+", "m+", "y+", "g+", "b+", "r+", "m+", "y+" ]
    colors = [ "black","gray","black","black", "b+", "r+", "m+", "y+", "g+", "b+", "r+", "m+", "y+" ]
    color = 0
