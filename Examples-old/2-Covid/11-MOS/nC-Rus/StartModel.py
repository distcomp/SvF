...
Data=Select ( 'Select nCR,t,date from DataAll As Data where date<= endDate' )
...
SvF_MakeSets_byParam ( co.curentTabl.dat('t'), 9,2 )
 											# co.resF = 'MNG-nCR.res'
co.resF='MNG-nCR.res'
Task.AddDef('co.resF',['MNG-nCR.res'])
 											# Obj:     nCR.MSDnan() + nCR.ComplSig2(Penal[0])from __future__ import division
from  numpy import *
