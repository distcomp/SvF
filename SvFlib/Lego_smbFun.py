...
class smbFun (BaseFun) :
    def __init__ (self, Vname='',  As=[], param=False, Degree=-1,  Finitialize = 0, DataReadFrom = '',Data=[], Type='smbFun',
        ...
        BaseFun.__init__(self, Vname, As, param, Degree, Finitialize, DataReadFrom, Data, Type, Domain, ArgNorm)
...
#                self.ArgNorm = True
    #            print (argxy, step,self.A[0].step,self.ArgNorm)
     #           if argxy[0]==1 and argxy[1]==1 : print (argxy, arg, step,self.A[0].step,self.ArgNorm)
