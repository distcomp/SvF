...
Task = SvF.Task
SvF.mngF = 'MAN.mng'
SvF.TaskName="4Body3D_Trajectories"; 
...
def createGr ( Task, Penal ) :
    ...
    z2.TrainingSets = SvF.TrainingSets
 											# x1.MSD()+y1.MSD()+z1.MSD()+x2.MSD()+y2.MSD()+z2.MSD()+x1.Complexity([Penal[0]])+y1.Complexity([Penal[1]])+z1.Complexity([Penal[2]])+x2.Complexity([Penal[3]])+y2.Complexity([Penal[4]])+z2.Complexity([Penal[5]])
