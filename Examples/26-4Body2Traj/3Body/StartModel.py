...
DB = Table ( '../4bdn-1_0.9_0.2_0.06-abc.xlsx','DB','t,x1,y1,z1,x2,y2,z2,x3,y3,z3' )
...
Plot( [ [ DB.dat('x1'), DB.dat('y1'), 'lw=0', 'c=red', "marker='o'", 'ms=2', "label='Data1'", "xlab='x'", 'xlab_x=1.01', "ylab='y'"], [DB.dat('x2'), DB.dat('y2'), 'lw=0', 'c=green', "marker='o'", 'ms=2', "label='Data2'"], [x1.grd, y1.grd, 'c=red', 'lw=2', "label='Planet1'", 'ms=0'], [P1, 'ms=5', "label=''"], [x2.grd, y2.grd, 'c=green', 'lw=2', "label='Planet2'", 'ms=0'], [P2, 'ms=5', "label=''"], [x3.grd, y3.grd, 'c=blue', 'lw=2', "label='Planet3'", 'ms=0'], [P3, 'ms=5', "label=''"] ] )
Plot( [ [ DB.dat('x1'), DB.dat('y1'), 'lw=0', 'c=red', "marker='o'", 'ms=2', "label='Data1'", "xlab='x'", 'xlab_x=1.01', "ylab='y'"], [DB.dat('x2'), DB.dat('y2'), 'lw=0', 'c=green', "marker='o'", 'ms=2', "label='Data2'"], [DB.dat('x3'), DB.dat('y3'), 'lw=0', 'c=blue', "marker='o'", 'ms=0.5', "label='Data3'"], [x1.grd, y1.grd, 'c=red', 'lw=2', "label='Planet1'", 'ms=0'], [x2.grd, y2.grd, 'c=green', 'lw=2', "label='Planet2'"], [x3.grd, y3.grd, 'c=blue', 'lw=2', "label='Planet3'"] ] )
Plot( [ [ x1, 'c=r'], [y1, 'c=g'], [z1, 'c=b', "ylab='x1,y1,z1'", 'ylab_x=.02'] ] )
Plot( [ [ x2, 'c=r'], [y2, 'c=g'], [z2, 'c=b', "ylab='x2,y2,z2'", 'ylab_x=.02'] ] )
Plot( [ [ x3, 'c=r', 'dms=0.0'], [y3, 'c=g'], [z3, 'c=b', "ylab='x3,y3,z3'", 'ylab_x=.02'] ] )
