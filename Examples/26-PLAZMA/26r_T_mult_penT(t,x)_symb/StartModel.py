...
for _ir in Dat.sR:
  ...
  if ni<3:
    print("step between s too small. See after ",s_old)
    exit(-1)
  s_old=Dat.dat('s')[_ir]
...
def createGr ( Task, Penal ) :
    ...
    Tt.var = py.Var ( Tt.A[0].NodS,domain=Reals )
    Tt.gr =  Tt.var
    Gr.Tt =  Tt.var

    Tr.var = py.Var ( Tr.A[0].NodS,domain=Reals )
    Tr.gr =  Tr.var
    Gr.Tr =  Tr.var
 								# Tr(0.5)=1
    def EQ0 (Gr) :
