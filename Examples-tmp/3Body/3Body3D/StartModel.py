...
SvF.TaskName="3Body"; 
DDD = Table ( '3Body3D.dat','DDD','t,x1,y1,z1,x2,y2,z2,x3,y3,z3' )
...
def createGr ( Task, Penal ) :
    ...
    z3.TrainingSets = SvF.TrainingSets
 											# x1.MSD()+y1.MSD()+z1.MSD()+x2.MSD()+y2.MSD()+z2.MSD()+x3.MSD()+y3.MSD()+z3.MSD()+x1.Complexity([Penal[0]])+y1.Complexity([Penal[1]])+z1.Complexity([Penal[2]])+x2.Complexity([Penal[3]])+y2.Complexity([Penal[4]])+z2.Complexity([Penal[5]])+x3.Complexity([Penal[6]])+y3.Complexity([Penal[7]])+z3.Complexity([Penal[8]])
